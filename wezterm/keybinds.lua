...
M.tmux_keybinds = {
	...
	{ key = "h", mods = "ALT|SHIFT|CMD", action = act({ AdjustPaneSize = { "Left", 1 } }) },
	{ key = "l", mods = "ALT|SHIFT|CMD", action = act({ AdjustPaneSize = { "Right", 1 } }) },
	{ key = "k", mods = "ALT|SHIFT|CMD", action = act({ AdjustPaneSize = { "Up", 1 } }) },
	{ key = "j", mods = "ALT|SHIFT|CMD", action = act({ AdjustPaneSize = { "Down", 1 } }) },
